...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    uploadRetryIcon: '<i class="fa fa-long-arrow-alt-left"></i>',
                    ...
                    dragIcon: '<i class="fa fa-arrow-right"></i>',
                    dragClass: 'text-info',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="fa fa-play fa-rotate-180"></i>',
            next: '<i class="fa fa-play"></i>',
            toggleheader: '<i class="fa fa-arrows-alt-v pl-1 pr-1"></i>',
            fullscreen: '<i class="fa fa-expand-alt"></i>',
        ...
        customLayoutTags: {},
        customPreviewTags: {},
        previewFileIcon: '<i class="fa fa-file-alt fa-md mt-2"></i>',
